...
const Signup = () => {
    ...
    const { username, email, password, password2, successMsg, errorMsg, loading, role, address, country } = formData;
    ...
    const handlerSubmit = (evt) => {
        ...
        {setFormData({
            ...formData, errorMsg: 'Address length must be greater than 10'
        })
            ...
            // });
            const { username, email, password,address,role,country } = formData;
            const data = { username, email, password,address,role,country };
    ...
    const showSignupForm = () => (
        ...
        <form className="signu-form" style={{ "color": "white" }} onSubmit={handlerSubmit} noValidate>
            ...
            <div className="input-group mb-3">
                ...
                <select className="form-select" required name="country" value={country} onChange={handlerChange}>
            ...
            <div className="input-group mb-3">
                ...
                <select className="form-select" required name="role" value={role} onChange={handlerChange}>
            ...
            <p className="text-center text-white">
                Have a account? <Link to="/signin"><b>Log In</b></Link>
            </p>
        </form>
